...
template <>
void bidiarray<bool>::display();

template <>
void bidiarray<Sint16>::display();

template <>
string bidiarray<bool>::serialize();

template <>
string bidiarray<Sint16>::serialize();

template <>
bidiarray<bool> bidiarray<bool>::deserialize(string r);

template <>
bidiarray<Sint16> bidiarray<Sint16>::deserialize(string r);
